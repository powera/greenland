"""Croatian-specific type definitions for linguistic forms."""
...
class CroatianGender(Enum):
    """Croatian grammatical gender."""
...
class NounDeclension:
    """Croatian noun declension results.

    Croatian nouns have singular and plural forms.
    Croatian has three genders: masculine, feminine, and neuter.
    """

    word: str
    gender: Optional[CroatianGender] = None
...
class VerbConjugation:
    """Croatian verb conjugation results.

    Croatian verbs conjugate by person and number across multiple tenses.
    """
