"""Bulgarian-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Bulgarian noun declension results.

    Bulgarian nouns have singular and plural forms.
    Bulgarian has three genders: masculine, feminine, and neuter.
    """

    word: str
    gender: Optional[BulgarianGender] = None
...
class VerbConjugation:
    """Bulgarian verb conjugation results.

    Bulgarian verbs conjugate by person and number across multiple tenses.
    """
