"""Latvian-specific type definitions for linguistic forms."""
...
class LatvianGender(Enum):
    """Latvian grammatical gender."""
...
class NounDeclension:
    ...
    word: str
    gender: Optional[LatvianGender] = None
...
class VerbConjugation:
    """Latvian verb conjugation results.

    Latvian verbs conjugate by person and number across multiple tenses.
    """
