"""Hindi-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Hindi noun declension results.

    Hindi nouns have grammatical gender (masculine/feminine) and number
    (singular/plural).  They inflect for direct and oblique cases.
...
class VerbConjugation:
    """Hindi verb conjugation results.

    Hindi verbs conjugate for person, number, gender, tense, and aspect.
    The main tenses are present habitual, past (perfective), and future.
    Verbs are listed in the infinitive form ending in -ना (-na).
    """
