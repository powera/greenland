"""Greek-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Greek noun declension results.

    Greek nouns have singular and plural forms. Each noun has a fixed
    grammatical gender.
    """

    word: str
    gender: Optional[GreekGender] = None
...
class VerbConjugation:
    """Greek verb conjugation results.

    Greek verbs conjugate by person and number across multiple tenses.
    """
    ...
    # Future (Μέλλοντας - θα + subjunctive)
    FUTURE_FORMS = [
        "1s_future",
        "2s_future",
        "3s_future",
