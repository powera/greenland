"""Burmese-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Burmese noun form results.

    Burmese is an isolating language; nouns do not inflect for number.
    Plurality can be indicated by particles (e.g. တွေ or များ) or context.
    We store singular and plural forms for pedagogical purposes.
    """
...
class VerbConjugation:
    """Burmese verb form results.

    Burmese verbs do not conjugate for person or number.  Tense and aspect
    are indicated by sentence-final particles (e.g. တယ် for present,
    ခဲ့တယ် for past, မယ် for future).  We store the base form plus
    common tense constructions.
    """
