"""Danish-specific type definitions for linguistic forms."""
...
class DanishGender(Enum):
    """Danish grammatical gender."""

    COMMON = "c"  # en-words (faelleskon)
    NEUTER = "n"  # et-words (intetkon)


@dataclass
class NounDeclension:
    """Danish noun declension results.

    Danish nouns have singular and plural forms.
    Gender is indicated by the indefinite article (en/et).
    """

    word: str
    gender: Optional[DanishGender] = None
...
class VerbConjugation:
    """Danish verb conjugation results.

    Danish verbs do not conjugate by person -- all persons use the same form
