"""Telugu-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Telugu noun declension results.

    Telugu nouns have singular and plural forms. Telugu has three genders
    (masculine, feminine, neuter) for pronouns but nouns are typically
    classified as human/non-human rather than by grammatical gender.
    """
...
class VerbConjugation:
    """Telugu verb conjugation results.
