"""Finnish-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Finnish noun declension results.

    Finnish nouns have singular and plural forms. Finnish has no grammatical
    gender. Nouns decline across 15 cases, but the base forms are
    singular/plural.
    """
...
class VerbConjugation:
    """Finnish verb conjugation results.

    Finnish verbs conjugate by person and number across multiple tenses.
    """
    ...
    # Future (Futuuri - tulla + present participle)
    FUTURE_FORMS = [
        "1s_future",
        "2s_future",
        "3s_future",
