"""Hungarian-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Hungarian noun declension results.

    Hungarian nouns have singular and plural forms. Hungarian has no
    grammatical gender. Nouns take various suffixes for cases, but the
    base forms are singular/plural.
    """
...
class VerbConjugation:
    """Hungarian verb conjugation results.

    Hungarian verbs conjugate by person and number across multiple tenses.
    """
    ...
    # Future (Jövő idő - fog + infinitive)
    FUTURE_FORMS = [
        "1s_future",
        "2s_future",
        "3s_future",
