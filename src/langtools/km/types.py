"""Khmer-specific type definitions for linguistic forms."""
...
class NounDeclension:
    """Khmer noun form results.

    Khmer is an isolating language with no inflectional morphology.
    Nouns do not change form for singular/plural; plurality is expressed
    through context, numerals, or reduplication.  We store singular and
    plural forms for pedagogical purposes.
    """
...
class VerbConjugation:
    """Khmer verb form results.

    Khmer verbs do not conjugate for person, number, or tense.  Tense
    and aspect are expressed with auxiliary words and context.  We store
    the base form plus common tense constructions for pedagogical purposes.
    """
