"""Czech-specific type definitions for linguistic forms."""
...
class CzechGender(Enum):
    """Czech grammatical gender."""
...
class NounDeclension:
    """Czech noun declension results.

    Czech nouns have singular and plural forms.
    Czech has three genders: masculine, feminine, and neuter.
    """

    word: str
    gender: Optional[CzechGender] = None
...
class VerbConjugation:
    """Czech verb conjugation results.

    Czech verbs conjugate by person and number across multiple tenses.
    """
