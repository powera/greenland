"""Maltese-specific type definitions for linguistic forms."""
...
class MalteseGender(Enum):
    """Maltese grammatical gender."""
...
class NounDeclension:
    """Maltese noun declension results.

    Maltese nouns have singular and plural forms.
    Each noun has a fixed grammatical gender (masculine or feminine).
    """

    word: str
    gender: Optional[MalteseGender] = None
...
class VerbConjugation:
    """Maltese verb conjugation results.

    Maltese verbs conjugate by person and number across multiple tenses.
    """
