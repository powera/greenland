#!/usr/bin/env python3
"""Application service for exporting database content in WireWord format."""
...
class WirewordExportService:
    """Coordinate a WireWord export for one target/source language pair."""
    ...
    def _upload_to_cdn(self, wireword_dir: str) -> Tuple[bool, list[Dict[str, str]]]:
        ...
        return cast(
            ...
            uploader.upload_wireword_directory(wireword_dir, language_code),
        )
