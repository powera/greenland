#!/usr/bin/env python3
"""
POS subtype HTML report generation.
...
class POSSubtypeReportGenerator:
    """Generate HTML report pages for POS subtypes."""
...
PovasAgent = POSSubtypeReportGenerator
...
def main() -> None:
    ...
    agent = POSSubtypeReportGenerator(config=config)
