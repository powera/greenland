...
Respond ONLY with the JSON format above."""
    ...
    def check_audio_file(
        self, audio_path: str, expected_word: str, language: str = DEFAULT_LANGUAGE
    ) -> AudioAnalysisResult:
        """
        ...
        try:
            ...
            for choice in response.choices:
                ...
                print(
                    f"Content length: {len(choice.message.content) if choice.message.content else 0}"
                )
    ...
    def batch_check_audio_files(
        self, audio_files: List[Tuple[str, str]], language: str = DEFAULT_LANGUAGE
