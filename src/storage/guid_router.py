"""Route a GUID to the right entity kind (lemma / phrase / sentence).
...
GuidKind = Literal["lemma", "phrase", "sentence"]
...
def resolve_guid(
...
) -> Tuple[GuidKind, Optional[Union[Lemma, Phrase, Sentence]]]:
    ...
    """
    kind = guid_kind(guid)
    obj: Optional[Union[Lemma, Phrase, Sentence]]
    if kind == "sentence":
