...
def get_lemmas_by_subtype_and_level(
    ...
    if lang_code and difficulty_level != -1:
        from storage.crud.difficulty_override import get_effective_difficulty_level
...
def handle_lemma_type_subtype_change(
    ...
    if type_changed:
        from storage.translation_helpers import LANGUAGE_FIELDS, get_all_translations
