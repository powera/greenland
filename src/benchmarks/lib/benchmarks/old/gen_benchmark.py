...
from benchmarks.lib.benchmarks.definitions import DefinitionsGenerator
from benchmarks.lib.benchmarks.spell_check import SpellCheckGenerator
from benchmarks.lib.benchmarks.translation import TranslationGenerator
...
def load_general_knowledge_to_database(session: Optional[Session] = None) -> None:
    ...
    DIR = os.path.join(benchmark_constants.BENCHMARK_DATA_DIR, "0040_general_knowledge")
