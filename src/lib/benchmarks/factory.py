...
def register_generator(benchmark_code: str, generator_class: Type[BenchmarkGenerator]) -> None:
    ...
    logger.debug(
        "Registered generator %s for benchmark %s", generator_class.__name__, benchmark_code
    )
...
def register_runner(benchmark_code: str, runner_class: Type[BenchmarkRunner]) -> None:
    ...
    logger.debug("Registered runner %s for benchmark %s", runner_class.__name__, benchmark_code)
