    ...
    def generate_chat(self, prompt, model, json_schema=None, structured_json=False):
        ...
        if definition_match:
            ...
            if definition == "A large gray mammal with a trunk" and word == "elephant":
                responses = {
                    "granite3-dense": {
                        "explanation": "Accurate definition capturing key features",
                        "valid": True,
                        "confidence": 95,
                    },
                    "qwen2.5": {
                        "explanation": "Definition matches primary characteristics",
                        "valid": True,
                        "confidence": 90,
                    },
                    "gemma2": {
                        "explanation": "Definition is correct but could be more specific",
                        "valid": True,
                        "confidence": 85,
                    },
                }
                ...
                responses = {
                    "granite3-dense": {
                        "explanation": "Definition does not match the word",
                        "valid": False,
                        "confidence": 80,
                    },
                    "qwen2.5": {
                        "explanation": "No relationship between definition and word",
                        "valid": False,
                        "confidence": 85,
                    },
                    "gemma2": {
                        "explanation": "Completely mismatched definition",
                        "valid": False,
                        "confidence": 75,
                    },
                }
        ...
        # General knowledge validation responses
            ...
            if (
                ...
                responses = {
                    ...
                    "gemma2": {
                        "explanation": "Correct capital city identified",
                        "valid": True,
                        "confidence": 95,
                    },
                }
                ...
                responses = {
                    "granite3-dense": {
                        "explanation": "Mathematical error in response",
                        "valid": False,
                        "confidence": 100,
                    },
                    "qwen2.5": {
                        "explanation": "Incorrect arithmetic answer",
                        "valid": False,
                        "confidence": 98,
                    },
                    "gemma2": {
                        "explanation": "Response does not match correct solution",
                        "valid": False,
                        "confidence": 95,
                    },
                }
        ...
        # Ambiguous meaning validation responses
            ...
            if sentence == "I went to the bank yesterday" and word == "bank":
                responses = {
                    "granite3-dense": {
                        "explanation": "Multiple valid meanings (financial/river)",
                        "valid": True,
                        "confidence": 90,
                    },
                    "qwen2.5": {
                        "explanation": "Word has financial and geographical meanings",
                        "valid": True,
                        "confidence": 85,
                    },
                    "gemma2": {
                        "explanation": "Clear case of lexical ambiguity",
                        "valid": True,
                        "confidence": 88,
                    },
                }
...
class TestResponseValidator(unittest.TestCase):
    ...
    def test_validate_correct_general_knowledge(self):
        ...
        result = self.validator.validate(
            "Paris", "general_knowledge", expected="Paris", context="What is the capital of France?"
        )
        self.assertTrue(result.valid)
    ...
    def test_validate_incorrect_general_knowledge(self):
        ...
        result = self.validator.validate(
            "5", "general_knowledge", expected="4", context="What is 2+2?"
        )
        self.assertFalse(result.valid)
        self.assertGreater(result.confidence, 95)
    ...
    def test_validate_ambiguous_meaning(self):
        ...
        result = self.validator.validate(
            "bank", "ambiguous_meaning", expected="bank", context="I went to the bank yesterday"
        )
        self.assertTrue(result.valid)
