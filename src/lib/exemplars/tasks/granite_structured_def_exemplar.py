...
def create_definition_schema() -> Schema:
    ...
    definition_properties = {
        "definition": SchemaProperty(type="string", description="The definition text"),
        ...
        "subtype": SchemaProperty(type="string", description="The part-of-speech subtype"),
        "phonetic": SchemaProperty(
            type="string",
            description="Simplified phonetic pronunciation with stressed syllables in caps",
        ),
        "lemma": SchemaProperty(type="string", description="The base form of the word"),
        "ipa": SchemaProperty(
            type="string", description="IPA pronunciation of the word (American English)"
        ),
        ...
        "examples": SchemaProperty(
            type="array", description="Example sentences showing usage", items={"type": "string"}
        ),
        "notes": SchemaProperty(
            type="string", description="Additional notes about this definition", required=False
        ),
        "chinese_translation": SchemaProperty(
            type="string", description="Chinese translation for this specific meaning"
        ),
        "korean_translation": SchemaProperty(
            type="string", description="Korean translation for this specific meaning"
        ),
    ...
    return Schema(
        ...
        properties={
            "word": SchemaProperty(type="string", description="The word being defined"),
