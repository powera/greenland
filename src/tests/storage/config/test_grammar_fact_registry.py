...
def test_release_registry_accepts_exact_and_verb_form_prefix_facts() -> None:
    ...
    assert is_release_grammar_fact_type("en", "gradability")
    assert is_release_grammar_fact_type("zh", "measure_words")
    assert is_release_grammar_fact_type("en", "fanciful_collective")
    ...
    # measure_words is zh-only and fanciful_collective en-only; neither crosses over
    assert not is_release_grammar_fact_type("en", "measure_words")
    assert not is_release_grammar_fact_type("zh", "fanciful_collective")
    ...
    assert not is_release_grammar_fact_type("fr", "gradability")
