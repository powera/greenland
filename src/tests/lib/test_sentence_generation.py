...
class TestSentenceGenerator(unittest.TestCase):
    ...
    def test_english_verb_forms(self):
        ...
        # Present tense
        self.assertEqual(self.generator._get_english_verb_form("eat", "I", "present"), "eat")
        self.assertEqual(self.generator._get_english_verb_form("eat", "he", "present"), "eats")

        # Future tense
        self.assertEqual(self.generator._get_english_verb_form("eat", "I", "future"), "will eat")
    ...
    @patch("benchmarks.lib.sentence_generation.UnifiedLLMClient")
    def test_llm_generation(self, mock_client_class):
        ...
        generator = SentenceGenerator(
            self.sample_matrices, self.sample_grammar, llm_client=mock_client
        )
