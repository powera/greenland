...
def _build_error_response(message: str, status_code: int = 400) -> tuple:
...
def get_lemma_translations(guid: str):
    """
...
def get_lemma_grammar(guid: str):
    """
...
def get_lemma_sentences(guid: str):
    """
