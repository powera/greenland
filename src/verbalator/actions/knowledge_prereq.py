                    ...
                    "items": {
                        ...
                        "properties": {
                            "domain": {
                                ...
                                "description": "The knowledge domain required",
                            },
                            "other_domain_name": {
                                "type": "string",
                                "description": "If domain is 'other', the specific domain name",
                            },
                            "level": {
                                "type": "string",
                                "enum": [
                                ...
                                "description": "Approximate education level required for this domain",
                            },
                            "concepts": {
                                "type": "array",
                                "items": {
