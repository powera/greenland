...
#
# Note on pluricentric languages:
# Some languages have regional variants with distinct vocabulary/spelling (e.g., zh-CN vs zh-TW).
# These are stored as separate language codes with explicit regional suffixes following BCP 47.
# The "base" codes (zh, es, pt) are DEPRECATED and should be migrated to explicit regional codes.
LANGUAGE_FIELDS = {
    "en": ("lemma_text", "English", False),  # English uses lemma_text field
    "lt": ("lt", "Lithuanian", True),
    # Chinese regional variants (explicit codes preferred over base "zh")
    "zh": ("zh", "Chinese", True),  # DEPRECATED: use zh-CN, zh-TW, or zh-HK
    "zh-CN": ("zh-CN", "Chinese (Simplified, Mainland)", True),
    "zh-TW": ("zh-TW", "Chinese (Traditional, Taiwan)", True),
    "zh-HK": ("zh-HK", "Cantonese (Hong Kong)", True),
    "fr": ("fr", "French", True),
    # Spanish regional variants (explicit codes preferred over base "es")
    "es": ("es", "Spanish", True),  # DEPRECATED: use es-ES or es-419
    "es-ES": ("es-ES", "Spanish (Spain)", True),
    "es-419": ("es-419", "Spanish (Latin America)", True),
    "de": ("de", "German", True),
    "it": ("it", "Italian", True),
    "nl": ("nl", "Dutch", True),
    # Portuguese regional variants (explicit codes preferred over base "pt")
    "pt": ("pt", "Portuguese", True),  # DEPRECATED: use pt-BR or pt-PT
    "pt-BR": ("pt-BR", "Portuguese (Brazil)", True),
    "pt-PT": ("pt-PT", "Portuguese (Portugal)", True),
    "sv": ("sv", "Swedish", True),
