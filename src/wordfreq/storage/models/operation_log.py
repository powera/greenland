...
class OperationLog(Base):
    ...
    operation_type: Mapped[str] = mapped_column(String, nullable=False, index=True)  # e.g., "translation", "definition", "import"
    timestamp: Mapped[datetime.datetime] = mapped_column(TIMESTAMP, server_default=func.now(), index=True)
