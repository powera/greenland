...
"""Generate English adverb forms using the shared task registry."""
...
TASK_KEY = "english_adverbs"
CONFIG = FORM_GENERATION_TASKS[TASK_KEY].config


def get_english_adverb_lemmas(config: DataSourceConfig, limit: Optional[int] = None):
