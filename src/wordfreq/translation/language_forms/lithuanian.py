...
NOUN_FORM_MAPPING = {
    "nominative_singular": GrammaticalForm.NOUN_LT_NOM_S,
    "genitive_singular": GrammaticalForm.NOUN_LT_GEN_S,
    "dative_singular": GrammaticalForm.NOUN_LT_DAT_S,
    "accusative_singular": GrammaticalForm.NOUN_LT_ACC_S,
    "instrumental_singular": GrammaticalForm.NOUN_LT_INS_S,
    "locative_singular": GrammaticalForm.NOUN_LT_LOC_S,
    "vocative_singular": GrammaticalForm.NOUN_LT_VOC_S,
    "nominative_plural": GrammaticalForm.NOUN_LT_NOM_P,
    "genitive_plural": GrammaticalForm.NOUN_LT_GEN_P,
    "dative_plural": GrammaticalForm.NOUN_LT_DAT_P,
    "accusative_plural": GrammaticalForm.NOUN_LT_ACC_P,
    "instrumental_plural": GrammaticalForm.NOUN_LT_INS_P,
    "locative_plural": GrammaticalForm.NOUN_LT_LOC_P,
    "vocative_plural": GrammaticalForm.NOUN_LT_VOC_P,
}
...
ADJECTIVE_FORM_MAPPING = {
    "nominative_singular_m": GrammaticalForm.ADJ_LT_NOM_S_M,
    "genitive_singular_m": GrammaticalForm.ADJ_LT_GEN_S_M,
    "dative_singular_m": GrammaticalForm.ADJ_LT_DAT_S_M,
    "accusative_singular_m": GrammaticalForm.ADJ_LT_ACC_S_M,
    "instrumental_singular_m": GrammaticalForm.ADJ_LT_INS_S_M,
    "locative_singular_m": GrammaticalForm.ADJ_LT_LOC_S_M,
    "vocative_singular_m": GrammaticalForm.ADJ_LT_VOC_S_M,
    "nominative_singular_f": GrammaticalForm.ADJ_LT_NOM_S_F,
    "genitive_singular_f": GrammaticalForm.ADJ_LT_GEN_S_F,
    "dative_singular_f": GrammaticalForm.ADJ_LT_DAT_S_F,
    "accusative_singular_f": GrammaticalForm.ADJ_LT_ACC_S_F,
    "instrumental_singular_f": GrammaticalForm.ADJ_LT_INS_S_F,
    "locative_singular_f": GrammaticalForm.ADJ_LT_LOC_S_F,
    "vocative_singular_f": GrammaticalForm.ADJ_LT_VOC_S_F,
    "nominative_plural_m": GrammaticalForm.ADJ_LT_NOM_P_M,
    "genitive_plural_m": GrammaticalForm.ADJ_LT_GEN_P_M,
    "dative_plural_m": GrammaticalForm.ADJ_LT_DAT_P_M,
    "accusative_plural_m": GrammaticalForm.ADJ_LT_ACC_P_M,
    "instrumental_plural_m": GrammaticalForm.ADJ_LT_INS_P_M,
    "locative_plural_m": GrammaticalForm.ADJ_LT_LOC_P_M,
    "vocative_plural_m": GrammaticalForm.ADJ_LT_VOC_P_M,
    "nominative_plural_f": GrammaticalForm.ADJ_LT_NOM_P_F,
    "genitive_plural_f": GrammaticalForm.ADJ_LT_GEN_P_F,
    "dative_plural_f": GrammaticalForm.ADJ_LT_DAT_P_F,
    "accusative_plural_f": GrammaticalForm.ADJ_LT_ACC_P_F,
    "instrumental_plural_f": GrammaticalForm.ADJ_LT_INS_P_F,
    "locative_plural_f": GrammaticalForm.ADJ_LT_LOC_P_F,
    "vocative_plural_f": GrammaticalForm.ADJ_LT_VOC_P_F,
}
