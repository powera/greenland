...
VERB_FORM_MAPPING = {
    ...
    "3s-m_present": GrammaticalForm.VERB_ES_3S_M_PRESENT,
    "3s-f_present": GrammaticalForm.VERB_ES_3S_F_PRESENT,
    "1p_present": GrammaticalForm.VERB_ES_1P_PRESENT,
    "2p_present": GrammaticalForm.VERB_ES_2P_PRESENT,
    "3p-m_present": GrammaticalForm.VERB_ES_3P_M_PRESENT,
    "3p-f_present": GrammaticalForm.VERB_ES_3P_F_PRESENT,
    # Past (8 persons)
    ...
    "3s-m_future": GrammaticalForm.VERB_ES_3S_M_FUTURE,
    "3s-f_future": GrammaticalForm.VERB_ES_3S_F_FUTURE,
    "1p_future": GrammaticalForm.VERB_ES_1P_FUTURE,
    "2p_future": GrammaticalForm.VERB_ES_2P_FUTURE,
    "3p-m_future": GrammaticalForm.VERB_ES_3P_M_FUTURE,
    "3p-f_future": GrammaticalForm.VERB_ES_3P_F_FUTURE,
}
