...
"""Generate Portuguese verb forms using the shared task registry."""
...
TASK_KEY = "portuguese_verbs"
CONFIG = FORM_GENERATION_TASKS[TASK_KEY].config


def get_portuguese_verb_lemmas(config: DataSourceConfig, limit: Optional[int] = None):
