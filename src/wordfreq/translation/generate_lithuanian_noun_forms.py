...
"""Generate Lithuanian noun forms using the shared task registry."""
...
TASK_KEY = "lithuanian_nouns"
CONFIG = FORM_GENERATION_TASKS[TASK_KEY].config


def get_lithuanian_noun_lemmas(config: DataSourceConfig, limit: Optional[int] = None):
