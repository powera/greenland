...
"""Generate Spanish verb forms using the shared task registry."""
...
TASK_KEY = "spanish_verbs"
CONFIG = FORM_GENERATION_TASKS[TASK_KEY].config


def get_spanish_verb_lemmas(config: DataSourceConfig, limit: Optional[int] = None):
