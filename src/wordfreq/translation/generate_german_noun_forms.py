...
"""Generate German noun forms using the shared task registry."""
...
TASK_KEY = "german_nouns"
CONFIG = FORM_GENERATION_TASKS[TASK_KEY].config


def get_german_noun_lemmas(config: DataSourceConfig, limit: Optional[int] = None):
