...
def build_translation_prompt(
    ...
    context_lines = [
        ...
        "  * PRONOUNS - Use the following standardized forms (word itself shows person/number, tag shows function/case):",
        "    - For English, French, Spanish, Portuguese:",
        "      * 'pronoun/en_subjective' (I, you, he, she, we, they)",
        "      * 'pronoun/en_objective' (me, you, him, her, us, them)",
        "      * 'pronoun/en_possessive' (mine, yours, his, hers, ours, theirs - standalone forms)",
        "      * 'pronoun/en_reflexive' (myself, yourself, himself, herself, ourselves, themselves)",
        "      * Use same pattern for fr, es, pt: 'pronoun/fr_subjective', 'pronoun/es_objective', etc.",
        "    - For Lithuanian, German (languages with grammatical case):",
        "      * Use 'pronoun/lang_case' format: 'pronoun/lt_nominative' (aš, tu, jis, ji)",
        "      * 'pronoun/lt_accusative' (mane, tave, jį, ją), 'pronoun/lt_genitive' (manęs, tavęs)",
        "      * 'pronoun/lt_dative' (man, tau, jam, jai), 'pronoun/lt_instrumental' (manimi, tavimi)",
        "      * 'pronoun/lt_locative' (manyje, tavyje), 'pronoun/lt_possessive' (mano - mine standalone)",
        "      * 'pronoun/de_nominative' (ich, du, er, sie, es, wir), 'pronoun/de_accusative' (mich, dich, ihn)",
        "      * 'pronoun/de_dative' (mir, dir, ihm, ihr), 'pronoun/de_genitive' (meiner, deiner)",
        "      * 'pronoun/de_possessive' (meiner/meine - mine standalone), 'pronoun/de_reflexive' (sich)",
        "    - For Chinese, Korean:",
        "      * 'pronoun/zh_subjective' (我, 你, 他, 她, 它, 我们, 你们, 他们, 她们)",
        "      * 'pronoun/zh_possessive' (我的, 你的, 他的, 她的, 它的 - with 的)",
        "      * 'pronoun/ko_subjective' (나, 저, 너, 그, 그녀, 우리, 너희, 그들)",
        "      * 'pronoun/ko_possessive' (나의/내, 저의/제, 우리의/우리)",
        "  * NUMERALS - Cardinal (how many) and ordinal (which position) numbers:",
        "    - The lemma form for numerals is the cardinal form (one, two, three), masculine where gender applies.",
        "    - English (invariant): 'numeral/en_cardinal' (one, two), 'numeral/en_ordinal' (first, second)",
        "    - Lithuanian (gendered 1-9): 'numeral/lt_cardinal_m' (vienas, du), 'numeral/lt_cardinal_f' (viena, dvi)",
        "      * 'numeral/lt_ordinal_m' (pirmas), 'numeral/lt_ordinal_f' (pirma)",
        "    - German (ein gendered): 'numeral/de_cardinal_m' (ein), 'numeral/de_cardinal_f' (eine), 'numeral/de_cardinal_n' (ein)",
        "      * 'numeral/de_ordinal' (erste, zweite - adjective-like inflection)",
        "    - French: 'numeral/fr_cardinal_m' (un), 'numeral/fr_cardinal_f' (une)",
        "      * 'numeral/fr_ordinal_m' (premier), 'numeral/fr_ordinal_f' (première)",
        "    - Spanish: 'numeral/es_cardinal_m' (un/uno), 'numeral/es_cardinal_f' (una)",
        "      * 'numeral/es_ordinal_m' (primero), 'numeral/es_ordinal_f' (primera)",
        "    - Portuguese: 'numeral/pt_cardinal_m' (um), 'numeral/pt_cardinal_f' (uma)",
        "      * 'numeral/pt_ordinal_m' (primeiro), 'numeral/pt_ordinal_f' (primeira)",
        "    - Chinese: 'numeral/zh_cardinal' (一, 二, 三 - standard counting)",
        "      * 'numeral/zh_quantity' (一, 两, 三 - 两 replaces 二 before measure words)",
        "      * 'numeral/zh_ordinal' (第一, 第二, 第三)",
        "    - Korean: 'numeral/ko_native' (하나, 둘, 셋 - native Korean for counting)",
        "      * 'numeral/ko_sino' (일, 이, 삼 - Sino-Korean for dates/formal numbers)",
        "      * 'numeral/ko_ordinal' (첫째, 둘째, 셋째)",
