...
def build_translation_prompt(
    ...
    context_lines = [
        ...
        "  * PRONOUNS - Use the following standardized forms based on language type:",
        "    - For English, French, Spanish, Portuguese (languages with subject/object distinction):",
        "      * 'pronoun/en_subjective' (for 'I', 'you', 'he', 'she', 'we', 'they')",
        "      * 'pronoun/en_objective' (for 'me', 'you', 'him', 'her', 'us', 'them')",
        "      * 'pronoun/en_possessive' (for 'my', 'your', 'his', 'her', 'our', 'their')",
        "      * 'pronoun/en_reflexive' (for 'myself', 'yourself', 'himself', 'herself', 'ourselves', 'themselves')",
        ...
        "      * Use 'pronoun/lang_case_person': 'pronoun/lt_nominative_1s' (aš - I)",
        "      * 'pronoun/lt_accusative_1s' (mane - me), 'pronoun/lt_genitive_1s' (mano - my/of me)",
        "      * 'pronoun/lt_dative_3s_f' (jai - to her), 'pronoun/de_nominative_1p' (wir - we)",
        "      * Cases: nominative, accusative, genitive, dative, instrumental, locative",
        "    - For Chinese, Korean (languages without case distinction):",
        "      * Use 'pronoun/lang_person': 'pronoun/zh_1s' (我 - I/me), 'pronoun/zh_2s' (你 - you)",
        "      * Add gender when relevant: 'pronoun/zh_3s_m' (他 - he/him), 'pronoun/zh_3s_f' (她 - she/her)",
        "      * 'pronoun/zh_1p' (我们 - we/us), 'pronoun/ko_1s' (나/저 - I/me)",
