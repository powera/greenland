...
def main():
    ...
    parser.add_argument(
        "--output", default="rank_changes.txt", help="Output file name (default: rank_changes.txt)"
    )
    parser.add_argument(
        "--top", type=int, default=50, help="Number of top results to display (default: 50)"
    )
    parser.add_argument("--csv", action="store_true", help="Output results as CSV files")
