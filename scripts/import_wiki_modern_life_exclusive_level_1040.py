#!/usr/bin/env python3
"""Import the engineering, computing and everyday technology vocabulary that only the wiki_modern_life corpus attests.

Sourced from /word-tokens/corpus-skew?corpus=wiki_modern_life&exclusive=1 -- not the
...
Topic level 105 joins the tail of the ranked modern-life list. These
...
DIFFICULTY_LEVEL = 1040

# The corpus-exclusive words of wiki_modern_life on 2026-08-29, ordered by their rank
...
# load ("micro"), wiki markup fragments and
