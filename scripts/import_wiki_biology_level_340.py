...
The first 40 ranked words form the biology sample at general-curriculum level
340. The remaining, sharper domain vocabulary is stored at topic level 1010.
...
DIFFICULTY_LEVEL = 340
TOPIC_DIFFICULTY_LEVEL = 1010
