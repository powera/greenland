#!/usr/bin/env python3
"""Import the physical science vocabulary that leans toward the wiki_physical_science corpus.

Sourced from /word-tokens/corpus-skew?corpus=wiki_physical_science -- the words whose Zipf
